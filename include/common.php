<?php
			 ...
			 */
				...
				global $db_type;
				$db_type = "mysql";
				$db_user = "etransla_orlt1";
				$db_password = "5Zckflcw5iJj";
				$db_database = "etransla_orlt1";
				$db_server = "localhost";
				//$sf_phys_path = "/home/etransla/public_html/chineseproperties.com.au";
				$sf_phys_path = "C:\\xampp\\htdocs\\chinesecommercial";
...
/* 				$config["basepath"] = $misc->make_db_unsafe($recordSet->fields["controlpanel_basepath"]);
				...
				$config["basepath"] = "C:\\xampp\\htdocs\\chinesecommercial";
				$config["baseurl"] = "http://localhost:8080/chinesecommercial/";
