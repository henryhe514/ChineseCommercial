...
$lang['create_new_blog'] = "Novo Registo de Blog";
...
$lang['agent_default_num_featuredlistings_desc'] = 'Este é o número de Imóveis em Destaque que os agentes podem criar por defeito. (-1 = ilimitado).';
$lang['admin_listings_editor_featuredlistingerror'] = 'Limite de Imóveis em Destaque atingido. Este Imóvel não foi registado como "em Destaque".';
...
$lang['blog_must_login'] = 'Você precisa estar logado para registar um comentário.';
...
$lang['warning_addon_folder_not_writeable'] = 'Your Add-on directory is not writeable, the Add-on manager will not work correctly.';
...
$lang['addon_dir_removed'] = 'O directório do Add-on foi removido sem que o Add-on tenha sido instalado.';
$lang['addon_files_removed'] = 'Os ficheiros do Add-on foram removidos sem que o Add-on tenha sido instalado.';
$lang['addon_ok'] = 'Add-on OK';
$lang['addon_check_for_updates'] = 'Verificar actualizações deste Add-on';
$lang['addon_view_docs'] = 'Ver a ajuda do Add-on';
$lang['addon_uninstall'] = 'Remover o Add-on';
$lang['removed_addon'] = 'Add-on Removido';
$lang['addon_does_not_support_updates'] = 'Add-on não possui suporte para actualizações';
$lang['addon_update_server_not_avaliable'] = 'O servidor que actualiza este Add-on não está disponível neste momento';
$lang['addon_update_file_not_avaliable'] = 'O ficheiro de actualização deste Add-on não está disponível neste momento';
$lang['addon_already_latest_version'] = 'Você possui a versão mais recente do ';
$lang['addon_update_successful'] = 'Actualizado com sucesso';
$lang['addon_update_failed'] = 'Falha na Actualização';
...
$lang['signup_verification_code_not_valid'] = 'Você não digitou o código correcto.';
...
$lang['admin_new_user_email_verification'] = 'Para completar seu registo, deverá verificar sua Caixa Postal - um Email foi enviado para a sua conta. Você deve clicar no link enviado para activar e completar o seu registo.';
$lang['admin_new_user_email_verification_message'] = 'Para completar seu registo, a autenticidade do seu endereço de Email precisa ser verificado. Por favor clique no link abaixo para que uma mensagem seja enviada para o seu endereço de Email.';
...
$lang['blog_requires_moderation'] = 'Moderar Cometários';
